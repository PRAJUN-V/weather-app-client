...
const Weather = () => {
  ...
  useEffect(() => {
    search('Kannur'); // Default city on initial load
  }, []);

  return (
    <div className='bg-gradient-to-b from-orange-400 to-orange-600 h-screen flex flex-col items-center justify-center'>
      {/* Search Bar */}
      <div className='flex items-center rounded-full bg-white shadow-lg p-4 mb-6'>
        ...
        />
        <CiSearch
          className='text-gray-500 text-2xl cursor-pointer hover:text-orange-700 transition-all'
      ...
      {weatherData && (
        <>
          <div className='flex flex-col items-center mb-6'>
            ...
            <p className='text-xl text-white mt-2'>{weatherData.location}</p>
          </div>
